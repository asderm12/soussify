...
<head>
  <meta charset="utf-8">
  <title>Priv8 Mailer Inbox By Asderm12</title>
            ...
            <div class="col-sm-4" style="padding-left: 7.5px !important;">
              ...
              <div style="margin-bottom: 10px" class="input-group">
                    ...
                    <select class="form-control" onChange="Pilih4(this);">
                      ...
                      <option value="Mail Inb0x">Mail Inb0x Asderm12</option>
            ...
            <div class="col-sm-8" style="padding-right: 7.5px !important;">
              ...
              <div style="margin-bottom: 10px" class="input-group">
                    ...
                    <select class="form-control" onChange="Pilih1(this);">
                      ...
                      <option value="PayPaI">dental implant home</option>
                      <option value="PaypaI Service">dental-implant-home</option>
                      <option value="PaypaI Support">dentalimplanthome.com</option>
                    </select>
                    ...
                    <select class="form-control kanan" onChange="Pilih2(this);">
                      ...
                      <option value="Asderm_Post_Notification01@Inbox.com">Asderm_Post_Notification01@Inbox.com</option>
                      <option value="Asderm_Post_Notification02@Inbox.com">Asderm_Post_Notification02@Inbox.com</option>
                      <option value="Asderm_Post_Notification03@Inbox.com">Asderm_Post_Notification03@Inbox.com</option>
                      <option value="Asderm_Post_Notification04@Inbox.com">Asderm_Post_Notification04@Inbox.com</option>
                      <option value="Asderm_Post_Notification05@Inbox.com">Asderm_Post_Notification05@Inbox.com</option>
                      <option value="Asderm_Post_Notification06@Inbox.com">Asderm_Post_Notification06@Inbox.com</option>
                      <option value="Asderm_Post_Notification07@Inbox.com">Asderm_Post_Notification07@Inbox.com</option>
              ...
              <div style="margin-bottom: 10px" class="input-group">
                    ...
                    <select class="form-control kanan" onChange="Pilih3(this);">ge
                      ...
                      <option value="YGet that smile taken care of.">Get that smile taken care of.</option>
                      <option value="Will your smile last as long as you?">Will your smile last as long as you?</option>
                      <option value="Smile with your new dental implants.">Smile with your new dental implants.</option>
                      <option value="Smile with the strength of titanium.">Smile with the strength of titanium.</option>
                      <option value="Share a newer, younger smile today!">Share a newer, younger smile today!</option>
...
if ($action){
  ...
  $allemails = split("\n", $emaillist);
  $allemails = preg_replace('/([^|]*).*/', '$1', $emaillist);
